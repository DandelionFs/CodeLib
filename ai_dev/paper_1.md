...
动态部署问题描述及假设
- 不同时刻或者是不同服务器上的服务请求负载情况
- 不用时刻, 不同服务器的请求负载程度不同. 

> 假设场景中边缘服务器的数量为 N ，服务请求种类个数为Ｍ。在一段连续的时段中，根据边缘服务器上移动用户对所有服务的请求记录，求得服务动态部署策略π，即**每个时段计算获得 NｘＭ的矩阵Ｐ**，其**中P(ij)表示在边缘服务器es(i)上部署服务s(j)的服务资源配比**，使得尽可能获得**最佳平均服务响应时间**。


### 假设

1. 服务  ->  完成特定功能的原子服务, (不涉及服务之间组合完成特定功能的组合服务)
2. 服务之间不具有强相关性,无强依赖关系 -> 焦点在服务部署资源是否己完全占用? 
3. 以移动设备为基准
4. 传输中的请求报文和响应报文长度大致相等的
5. 单位传输时延是固定的
(传输是指移动设备与边缘服务器,边缘服务器之间或者边缘服务器与云数据中心的数据)
