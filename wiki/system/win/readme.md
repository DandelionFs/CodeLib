...
- 推荐设在机械盘里, 因为SSD写入寿命有限. 如果Win10跨盘访问需要更多时间的话, 推荐C盘, 其他不要求.
...
**基本输入输出系统**，是计算机组成中非常重要的一部分。BIOS 的基本功能是**负责初始化并测试计算机硬件是否正常**，然后**从硬盘中加载引导程序或从内存中加载操作系统**。同时 BIOS 也**负责对计算机硬件的参数管理**，例如修改硬盘运行模式、设备启动顺序等。
...
具体分区教程点击:[【搞机作战室】Win10磁盘分区 教程](https://zhuanlan.zhihu.com/p/52141844)
- [Windows系统压缩卷时可压缩空间远小于实际剩余空间解决方法](https://blog.csdn.net/Rained_99/article/details/54023914)
